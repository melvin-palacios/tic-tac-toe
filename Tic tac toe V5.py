from Import.IA import *
from Import.title_tic_tac_toe import *
# Tableau
board = {1: ' ', 2: ' ', 3: ' ',
         4: ' ', 5: ' ', 6: ' ',
         7: ' ', 8: ' ', 9: ' '}
...
def ask(i):
    ...
    if reponse in reponse_ask:
        ...
        print("Veuillez séléctionner une case")
        ask(i)
...
def check():
    result = checkli() + checkcol() + checkdia()
    return result
